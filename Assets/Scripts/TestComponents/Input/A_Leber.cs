...
namespace Test.Input {
	...
	public abstract class A_Leber : MonoBehaviour {
		...
		[SerializeField] private Direction4 _direction4;
		/// <summary>
		/// 四方向に抽象化した際のレバーの位置
		/// </summary>
		...
		[SerializeField] private Direction8 _direction8;
		/// <summary>
		/// 八方向に抽象化した際のレバーの位置
		/// </summary>
		...
		protected virtual void WasStartLoaded(){}
		...
		/// <summary>
		/// レバーの入力状態が変化した際に呼び出される
		/// </summary>
		/// <param name="pos"></param>
		private void WasChangedPos (Vector2 pos) {
			direction4 = ChangeVector2ForDireciton4(pos);
			direction8 = ChangeVector2ForDireciton8(pos);
		}
	}
}